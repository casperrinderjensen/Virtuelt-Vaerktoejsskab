...
<link href="styles/productpage/styles_el_products.css" rel="stylesheet">
	
<title>El Værktøj</title>
</head>
	...
	<div class="grid grid-pad">
		...
		<div class="col-1-1 mobile-col-1-1 header">
			...
			<div class="col-1-2 mobile-col-1-2 icon">
				<img src="img/skruemaskine.svg" alt="El Værktøjs ikon">
			</div>
		...
		<div class="col-1-1 mobile-col-1-1 products">
			...
			$sql = 'SELECT id, name, image, price FROM product WHERE category = "El værktøj"';
			...
			<table class="col-1-2 mobile-col-1-2">
				...
				<tr>
					<th class="bottom">
						...
						<a href="el_vaerktoej.php?id=<?php echo $id; ?>&add=yes">
		...
		if(filter_input(INPUT_GET, 'add')) {
			...
			// Hvis det ikke er set --> Lig med 1
			if(!isset($_SESSION['cart'][$_GET['id']]['quantity'])) { 
				$_SESSION['cart'][$_GET['id']]['quantity'] = 1;
			} 
			
			//Hvis det er set --> Tilføjer +1 til quantity hver gang "add" udføres
			else {
				$_SESSION['cart'][$_GET['id']]['quantity'] += 1;
			}
