	...
	<div class="grid grid-pad">
		...
		<div class="col-1-1 mobile-col-1-1 header">
			...
			<div class="col-1-2 mobile-col-1-2 icon">
				<img src="img/tilbehør.svg" alt="Tilbehørs ikon">
			</div>
		...
		<div class="col-1-1 mobile-col-1-1 products">
			...
			$sql = 'SELECT id, name, image, price FROM product WHERE category = "Tilbehør"';
			...
			<table class="col-1-2 mobile-col-1-2">
				...
				<tr>
					<th class="bottom">
						...
						<a href="tilbehoer.php?id=<?php echo $id; ?>&add=yes">
